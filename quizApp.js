...
//Let's say three people signed up for our service, create 3 instances of User and add each to the users Array
 ...
 quizUsers.push(new QuizUser('Katie', 'katieosmith@hotmail.com', 'jessie897', 50));
 quizUsers.push(new QuizUser('Bobby', 'bobbynutzman@gmail.com', 'katie0619', 75));
 quizUsers.push(new QuizUser('Carly', 'carly_smith@hotmail.com', 'dolphin89', 50));
